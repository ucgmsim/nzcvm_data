...
def main():
    ap = argparse.ArgumentParser(
        description="Compare two HDF5 tomography files (row-grouped random sampling per level)."
    )
    ...
    ap.add_argument(
        "--eps", type=float, default=1e-9, help="Epsilon for relative error denominator"
    )
